...
<?php echo file_get_contents('http://www.unl.edu/wdn/templates_3.0/includes/browserspecifics.html'); ?>
<?php echo file_get_contents('http://www.unl.edu/wdn/templates_3.0/includes/metanfavico.html'); ?>
...
<div id="wdn_wrapper">
    <div id="header"> <a href="http://www.unl.edu/" title="UNL website"><img src="/wdn/templates_3.0/images/logo.png" alt="UNL graphic identifier" id="logo" /></a>
        ...
        <?php echo file_get_contents('http://www.unl.edu/wdn/templates_3.0/includes/wdnTools.html'); ?>
    </div>
    ...
    <div id="wdn_content_wrapper">
        <div id="titlegraphic"><!-- TemplateBeginEditable name="titlegraphic" --><h1>UNL Directory</h1>
            <!-- TemplateEndEditable --></div>
        ...
        <div id="maincontent">
            ...
            <h3>Mark Pelini</h3>
            <p>Head Coach-Football, 472-3116</p>
            <div id="pf_mpelini3" class="wdn_annotate">
            ...
            <h3>Tom Osborne</h3>
            <p>Athletic Director, 472-3011</p>
            <div id="pf_tosborne2" class="wdn_annotate">
            ...
            <!-- TemplateEndEditable -->
            <div class="clear"></div>
            <?php echo file_get_contents('http://www.unl.edu/wdn/templates_3.0/includes/noscript.html'); ?>
            <!--THIS IS THE END OF THE MAIN CONTENT AREA.-->
        </div>
        <div id="footer">
            <div id="footer_floater"></div>
            <div class="footer_col">
                <?php echo file_get_contents('http://www.unl.edu/wdn/templates_3.0/includes/feedback.html'); ?>
            </div>
            <div class="footer_col"><!-- TemplateBeginEditable name="leftcollinks" -->
                <?php echo file_get_contents('http://www.unl.edu/ucomm/sharedcode/relatedLinks.html'); ?>
                <!-- TemplateEndEditable --></div>
            <div class="footer_col"><!-- TemplateBeginEditable name="contactinfo" -->
                ...
                <!-- TemplateEndEditable --></div>
            <div class="footer_col">
                <?php echo file_get_contents('http://www.unl.edu/wdn/templates_3.0/includes/socialmediashare.html'); ?>
            </div>
            ...
            <div id="wdn_copyright"><!-- TemplateBeginEditable name="footercontent" -->
                ...
                <!-- TemplateEndEditable -->
                <?php echo file_get_contents('http://www.unl.edu/wdn/templates_3.0/includes/wdn.html'); ?>
