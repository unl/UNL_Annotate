...
class UNL_Annotate_OutputController extends Savvy
{
     ...
     * @return UNL_Annotate_CacheInterface
     */
    static public function getCacheInterface()
    {
        if (!isset(self::$cache)) {
            self::setCacheInterface(new UNL_Annotate_CacheInterface_UNLCacheLite());
        }
        return self::$cache;
    }
    ...
    {
        if ($object instanceof UNL_Annotate_CacheableInterface
            || ($object                    instanceof Savvy_ObjectProxy
                && $object->getRawObject() instanceof UNL_Annotate_CacheableInterface)) {
            ...
            if ($object instanceof UNL_Annotate_PostRunReplacements) {
